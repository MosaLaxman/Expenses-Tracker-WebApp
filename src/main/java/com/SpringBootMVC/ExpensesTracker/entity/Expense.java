...
public class Expense {
    ...
    private Integer recurringSourceId;
    ...
    public Integer getRecurringSourceId() { return recurringSourceId; }
    public void setRecurringSourceId(Integer recurringSourceId) { this.recurringSourceId = recurringSourceId; }
